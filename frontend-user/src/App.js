...
import TaxPrediction from './pages/TaxPrediction'; // Make sure this is imported
import TaxForm from './components/TaxForm'; // ✅ Import TaxForm
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/taxprediction" element={<TaxPrediction />} />  {/* Added this route */}
